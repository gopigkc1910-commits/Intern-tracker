...
export function ApplicationStatusBoardPolished({ items }: { items: ApplicationRecord[] }) {
  ...
  return (
    <div className="space-y-4">
      ...
      {message ? <p className="rounded-2xl bg-mist px-4 py-3 text-sm text-slate">{message}</p> : null}
    </div>
  );
}
